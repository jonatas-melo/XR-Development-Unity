...
#pragma warning restore IDE0044
        ...
        void FindBaseControllerComponents()
        {
            ...
            if (m_BaseController == null)
            {
                ...
                if (m_BaseController == null)
                    Debug.LogWarning(
                        $"Cannot find any {nameof(XRBaseController)} component on the Base Controller GameObject.",
                        this);
            }
            ...
            if (m_BaseInteractor == null || m_BaseInteractor as Object == null)
            {
                ...
                if (m_BaseInteractor == null || m_BaseInteractor as Object == null)
                    Debug.LogWarning(
                        $"Cannot find any {nameof(IXRSelectInteractor)} component on the Base Controller GameObject.",
                        this);
            }
        ...
        void FindTeleportControllerComponents()
        {
            ...
            if (m_TeleportController == null)
            {
                ...
                if (m_TeleportController == null)
                    Debug.LogWarning(
                        $"Cannot find {nameof(XRBaseController)} component on the Teleport Controller GameObject.",
                        this);
            }
            ...
            if (m_TeleportInteractor == null)
            {
                ...
                if (m_TeleportInteractor == null)
                    Debug.LogWarning(
                        $"Cannot find {nameof(XRRayInteractor)} component on the Teleport Controller GameObject.",
                        this);
            }
        }
